...
```json
{
  ...
  "seed": 20260812,
  "started_at_unix": 1786501881.344337,
  "scientific_boundary": "Exploratory boundary-finding for temporal codeword information under an equal-exposure eligibility rule. Unequal-prefix decoding is treated only as a causal-onset diagnostic. No semantics, sender identity, coordination, agency, individuality, life, or Shannon-capacity claim.",
  ...
  "finished_at_unix": 1786502090.5092828,
  "stage0_reproducibility_passed": true,
  "final_verdict": "TEMPORAL_INFORMATION_SURVIVAL_CANDIDATE_LOCATED",
  "first_supported_level": "L3",
  "first_supported_elapsed_step": 12,
  "first_supported_after_lag": 0,
  "accuracy_figure": "static\\images\\books\\digital-life\\ch17-v3-05-information-boundary.png"
}
```
...
> The exploratory ladder first recovered codeword identity under equal cumulative pulse exposure at L3, elapsed step 12 (after_lag=0). This is a candidate boundary requiring independent confirmation.

```json
{
  "verdict": "TEMPORAL_INFORMATION_SURVIVAL_CANDIDATE_LOCATED",
  "bounded_claim": "The exploratory ladder first recovered codeword identity under equal cumulative pulse exposure at L3, elapsed step 12 (after_lag=0). This is a candidate boundary requiring independent confirmation.",
  "causal_onset_diagnostic_hits": [
    {
      "level": "L1",
      "elapsed_step": 8,
  ...
  "next_action": "Freeze the first equal-exposure positive rung and observation time, then run an independent confirmatory version with larger groups and a predeclared endpoint.",
  "explicit_nonclaims": [
    "semantics",
    "meaning",
    "understanding",
