...
We then tested a `6 × 6` board of thirty-six locally connected crystals.
...
```text
sequential RNG coupling                              Right OK ≈ 87% of independent-divergence scale
cell-keyed common-random-numbers (CRN) coupling      ≈ 11% of independent-divergence scale
```
