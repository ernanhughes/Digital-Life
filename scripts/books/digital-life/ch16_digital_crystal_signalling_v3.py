...
Experiment version: digital-crystal-signalling-v3.2
...
SIGNALLING_VERSION = "digital-crystal-signalling-v3.2"
SCHEMA_VERSION = 3
...
def stage_1_endogenous_sender(
    ...
    sender_capacity_fraction = assert_not_saturated(
        "Stage 1 sender",
        sender.state,
        profile["crystal_radius"],
        profile["max_capacity_fraction"],
    )
    receiver_capacity_fraction = assert_not_saturated(
        "Stage 1 receiver",
        receiver.state,
        profile["crystal_radius"],
        profile["max_capacity_fraction"],
    ...
    result = {
        ...
        "sender_capacity_fraction": sender_capacity_fraction,
        ...
        "receiver_capacity_fraction": receiver_capacity_fraction,
...
def main() -> None:
    ...
    metadata = {
        ...
        "saturation_policy": (
            "Stage 3 and Stage 6 use the longest common per-replicate horizon "
            "for which all compared conditions remain below the predeclared "
            "hard-radius capacity fraction; compared conditions use exactly "
            "the same horizon."
        ),
